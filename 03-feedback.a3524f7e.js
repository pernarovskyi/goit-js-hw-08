...
"use strict";var e=a(require("lodash/throttle"));function a(e){return e&&e.__esModule?e:{default:e}}const t="feedback-from-state",l=document.querySelector(".feedback-form"),s=JSON.parse(localStorage.getItem("STORAGE_KEY"));function o(e){e.preventDefault(),""!==l.email.value&&""!==l.message.value?(console.log({email:`${l.email.value}`,message:`${l.message.value}`}),localStorage.removeItem("STORAGE_KEY"),e.currentTarget.reset()):console.log("There is nothing to submit! Fill up the fields!")}function r(e){localStorage.setItem("STORAGE_KEY",JSON.stringify({email:`${l.email.value}`,message:`${l.message.value}`}))}s&&(l.email.value=s.email,l.message.value=s.message),l.addEventListener("submit",o),l.addEventListener("input",(0,e.default)(r,500));
},{"lodash/throttle":"Ywd4"}]},{},["TTyb"], null)
//# sourceMappingURL=/goit-js-hw-08/03-feedback.a3524f7e.js.map