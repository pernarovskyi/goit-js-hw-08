...
"use strict";var e=a(require("lodash/throttle"));function a(e){return e&&e.__esModule?e:{default:e}}const t="feedback-from-state",l=document.querySelector(".feedback-form"),s=JSON.parse(localStorage.getItem("STORAGE_KEY"));function r(e){e.preventDefault(),console.log({email:`${l.email.value}`,message:`${l.message.value}`}),localStorage.removeItem("STORAGE_KEY"),e.currentTarget.reset()}function o(e){localStorage.setItem("STORAGE_KEY",JSON.stringify({email:`${l.email.value}`,message:`${l.message.value}`}))}s&&(l.email.value=s.email,l.message.value=s.message),l.addEventListener("submit",r),l.addEventListener("input",(0,e.default)(o,500));
},{"lodash/throttle":"Ywd4"}]},{},["TTyb"], null)
//# sourceMappingURL=/goit-js-hw-08/03-feedback.7b729f67.js.map